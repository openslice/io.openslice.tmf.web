...
@Component({
    selector: 'resource-reservation-management',
    templateUrl: './resource-reservation-management.component.html',
    styleUrls: ['./resource-reservation-management.component.scss']
  })
export class ResourceReservationManagementComponent implements OnInit {
  ...
  //displayedColumns = [ 'name', 'version', 'lastUpdate',  'lifecycleStatus', 'actions']
  displayedColumns = [  'name', 'requestedPeriodStartDateTime',  'actions']
  ...
  // openReservationUpdateDialog(element: Reservation) {
  //   const dialogRef = this.dialog.open(EditReservationComponent, {data: element, disableClose: true})
