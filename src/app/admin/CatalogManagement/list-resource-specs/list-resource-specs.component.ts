...
@Component({
  ...
  templateUrl: './list-resource-specs.component.html',
  styleUrls: ['./list-resource-specs.component.scss'],
...
export class ListResourceSpecsComponent implements OnInit {
  ...
  retrieveSpecsList() {
    this.specService.listResourceSpecification({}).subscribe(
      data => { this.resourceSpecs = data },
      error => { console.error(error) },
      () => {
        this.dataSource.data = this.resourceSpecs
