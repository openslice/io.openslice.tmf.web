...
class LcmRuleSpecificationService extends __BaseService {
  static readonly listLCMRuleSpecificationPath = '/tmf-api/lcmrulesmanagement/v1/lcmRuleSpecification';
  static readonly createLCMRuleSpecificationPath = '/tmf-api/lcmrulesmanagement/v1/lcmRuleSpecification';
  static readonly retrieveLCMRuleSpecificationPath = '/tmf-api/lcmrulesmanagement/v1/lcmRuleSpecification/{id}';
  static readonly deleteLCMRuleSpecificationPath = '/tmf-api/lcmrulesmanagement/v1/lcmRuleSpecification/{id}';
  static readonly patchLCMRuleSpecificationPath = '/tmf-api/lcmrulesmanagement/v1/lcmRuleSpecification/{id}';
  ...
  listLCMRuleSpecificationResponse(params: LcmRuleSpecificationService.ListLCMRuleSpecificationParams): __Observable<__StrictHttpResponse<Array<LCMRuleSpecification>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/tmf-api/lcmrulesmanagement/v1/lcmRuleSpecification`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  retrieveLCMRuleSpecificationResponse(params: LcmRuleSpecificationService.RetrieveLCMRuleSpecificationParams): __Observable<__StrictHttpResponse<LCMRuleSpecification>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/tmf-api/lcmrulesmanagement/v1/lcmRuleSpecification/${encodeURIComponent(params.id)}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteLCMRuleSpecificationResponse(id: string): __Observable<__StrictHttpResponse<{}>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/tmf-api/lcmrulesmanagement/v1/lcmRuleSpecification/${encodeURIComponent(id)}`,
      __body,
      {
        headers: __headers,
        params: __params,
