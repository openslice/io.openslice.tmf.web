...
class EventsSubscriptionService extends __BaseService {
   ...
   */
  registerListener15Response(body: EventSubscriptionInput): __Observable<__StrictHttpResponse<EventSubscription | EventSubscription>> {
   ...
   * @return OK or Subscribed
   */
  registerListener15(body: EventSubscriptionInput): __Observable<EventSubscription | EventSubscription> {
    return this.registerListener15Response(body).pipe(
   ...
   * @return Deleted
   */
  unregisterListener15Response(id: string): __Observable<__StrictHttpResponse<Error>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @return Deleted
   */
  unregisterListener15(id: string): __Observable<Error> {
    return this.unregisterListener15Response(id).pipe(
